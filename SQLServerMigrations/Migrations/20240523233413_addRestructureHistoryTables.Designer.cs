...
namespace SQLServerMigrations.Migrations
{
    ...
    [Migration("20240523233413_addRestructureHistoryTables")]
    partial class addRestructureHistoryTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Service.Core.DataModel.Loan.LoanRestructureHistoryDataModel", b =>
                {
                    b.Property<int>("LoanRestructureHistoryID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("LoanRestructureHistoryID"));
                    ...
                    b.Property<int>("DisabledTerms")
                        .HasColumnType("int");

                    b.Property<int>("LoanID")
                        .HasColumnType("int");

                    b.Property<decimal>("NewTermAmount")
                        .HasColumnType("money");

                    b.Property<int>("NewTotalTerms")
                        .HasColumnType("int");

                    b.Property<decimal>("PreviousTermAmount")
                        .HasColumnType("money");

                    b.Property<int>("PreviousTotalTerms")
                        .HasColumnType("int");

                    b.HasKey("LoanRestructureHistoryID");

                    b.HasIndex("LoanID");

                    b.ToTable("LoanRestructureHistory");
                });

            modelBuilder.Entity("Service.Core.DataModel.Loan.LoanRestructureInstallmentsHistoryDataModel", b =>
                {
                    b.Property<int>("LoanRestructureInstallmentsHistoryID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("LoanRestructureInstallmentsHistoryID"));
                    ...
                    b.HasKey("LoanRestructureInstallmentsHistoryID");

                    b.HasIndex("LoanRestructureHistoryID");

                    b.HasIndex("SubPeriodID");

                    b.ToTable("LoanRestructureInstallmentsHistory");
                });
            ...
            modelBuilder.Entity("Service.Core.DataModel.LoanInstallmentsDataModel", b =>
                {
                    ...
                    b.Property<bool>("IsDisabledFromRestructuring")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Service.Core.DataModel.Loan.LoanRestructureInstallmentsHistoryDataModel", b =>
                {
                    b.HasOne("Service.Core.DataModel.Loan.LoanRestructureHistoryDataModel", "LoanRestructureHistory")
                        .WithMany("PreviousInstallments")
                        .HasForeignKey("LoanRestructureHistoryID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("LoanRestructureHistory");
            ...
            modelBuilder.Entity("Service.Core.DataModel.Loan.LoanRestructureHistoryDataModel", b =>
                {
                    b.Navigation("PreviousInstallments");
                });
